...
public class GenAnalyses extends DepthFirstAdapter
{
  ...
  public void createAnalysis()
  {
    ...
    try
    {
      file = new BufferedWriter(
               new FileWriter(
                 new File(pkgDir, "Visitor.java")));
    }
    catch(IOException e)
    {
      throw new RuntimeException("Unable to create " + new File(pkgDir, "Visitor.java").getAbsolutePath());
    }
  ...
  public void createAnalysisAdapter()
  {
    ...
    try
    {
      file = new BufferedWriter(
               new FileWriter(
                 new File(pkgDir, "AbstractVisitor.java")));
    }
    catch(IOException e)
    {
      throw new RuntimeException("Unable to create " + new File(pkgDir, "AbstractVisitor.java").getAbsolutePath());
    }
