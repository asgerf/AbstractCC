...
import asf.abstractcc.lexer.*;
import asf.abstractcc.node.*;
import asf.abstractcc.parser.*;
...
public class AbstractCC
{
  ...
  {
    System.out.println();
    System.out.println("AbstractCC version " + Version.VERSION);
    System.out.println("Copyright (C) 2010 Asger Feldthaus <asf@cs.au.dk> and");
    ...
    System.out.println();
    System.out.println("Type 'abstractcc -license' to view");
